  ...
  events = [
    {
      ...
      performedBy: { name: 'Customer Success Lead', role: 'Customer Experience Authority' },
    ...
    },
    {
      ...
      performedBy: { name: 'Logistics Operations Authority', role: 'Head of Logistics' },
    ...
    },
    {
      ...
      performedBy: { name: 'Program Director', role: 'Strategic Execution Office' },
    ...
    },
    {
      ...
      details: 'Captured cryptographic telemetry baseline for active dataset with SHA-256 seal.',
    ...
    },
    {
      ...
      performedBy: { name: 'Executive Sponsor', role: 'Executive Authority' },
      details: 'Assigned primary governance accountability to Customer Success Lead.',
