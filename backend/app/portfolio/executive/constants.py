...
RISK_CONCENTRATION_CRITICAL_PCT: float = 25.0
RISK_CONCENTRATION_HIGH_PCT: float = 15.0
RISK_CONCENTRATION_MODERATE_PCT: float = 5.0

# Intervention Score Thresholds
INTERVENTION_P1_SCORE_THRESHOLD: float = 60.0   # < 60.0 -> P1 Immediate Attention
INTERVENTION_P2_SCORE_THRESHOLD: float = 70.0   # 60.0-69.9 -> P2 High Attention
INTERVENTION_P3_SCORE_THRESHOLD: float = 80.0   # 70.0-79.9 -> P3 Monitor
